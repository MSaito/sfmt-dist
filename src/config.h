...
/* Define to 1 if compiler can use -mavx */
#define HAVE_AVX 0
...
/* Name of package */
#define PACKAGE "sfmt-dist"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "saito@manieth.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sfmt-dist"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sfmt-dist 0.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sfmt-dist"
