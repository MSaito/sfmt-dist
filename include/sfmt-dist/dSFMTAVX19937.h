#pragma once
#ifndef SFMT_DIST_DSFMTAVX19937_H
#define SFMT_DIST_DSFMTAVX19937_H
#include <stdint.h>
#include <string>
#include <inttypes.h>
...
#endif
        DSFMTAVX19937(int mexp, uint32_t seedValue);
        DSFMTAVX19937(uint32_t seedValue = 1234);
        DSFMTAVX19937(uint32_t seedValue[], int length);
        ~DSFMTAVX19937();
#if defined(DEBUG)
        void d_p();
#endif
...
#endif // SFMT_DIST_DSFMTAVX19937_H
